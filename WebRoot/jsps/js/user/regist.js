$(function () {
  ...
  $("#submitBtn").hover(
    function () {
      $("#submitBtn").attr("src", "/ZWJShop/images/regist2.jpg");
    },
    function () {
      $("#submitBtn").attr("src", "/ZWJShop/images/regist1.jpg");
    }
  );
  ...
  $(".inputClass").blur(function () {
    ...
    var funName =
      "validate" + id.substring(0, 1).toUpperCase() + id.substring(1) + "()"; //得到对应的校验函数名
    eval(funName); //执行函数调用
  });
...
function validateLoginname() {
   ...
   */
  $.ajax({
    url: "/ZWJShop/servlet/UserServlet", //要请求的servlet
...
function _hyz() {
  ...
  $("#imgVerifyCode").attr(
    "src",
    "ZWJShop/VerifyCodeServlet?a=" + new Date().getTime()
  );
}
