...
(function (window, undefined) {
  ...
  var jQuery = (function () {
    ...
    jQuery.fn = jQuery.prototype = {
      ...
      eq: function (i) {
        return i === -1 ? this.slice(i) : this.slice(i, Number(i) + 1);
      },
    ...
    jQuery.extend({
      ...
      grep: function (elems, callback, inv) {
        ...
        for (var i = 0, length = elems.length; i < length; i++) {
          retVal = Boolean(callback(elems[i], i));
          if (inv !== retVal) {
            ret.push(elems[i]);
          }
        }
      ...
      when: function (object) {
        var lastIndex = arguments.length,
          deferred =
            lastIndex <= 1 && object && jQuery.isFunction(object.promise)
              ? object
              : jQuery.Deferred(),
          ...
          var array = slice.call(arguments, 0),
            ...
            iCallback = function (index) {
              return function (value) {
                array[index] =
                  arguments.length > 1 ? slice.call(arguments, 0) : value;
                if (!--count) {
      ...
      sub: function () {
        ...
        jQuerySubclass.fn.init = function init(selector, context) {
          if (
            ...
            !(context instanceof jQuerySubclass)
          ) {
  ...
  (function () {
    ...
    jQuery.support = {
      ...
      htmlSerialize: Boolean(div.getElementsByTagName("link").length),
      ...
      cssFloat: Boolean(a.style.cssFloat),
  ...
  jQuery.extend({
    ...
    hasData: function (elem) {
      ...
      return Boolean(elem) && !isEmptyDataObject(elem);
    },
    ...
    data: function (elem, name, data, pvt /* Internal Use Only */) {
      ...
      if (
        (!id || (pvt && id && !cache[id][internalKey])) &&
        getByName &&
        data === undefined
      ) {
        return;
    ...
    attr: function (elem, name, value, pass) {
      ...
      if (elem.nodeType === 1) {
        ...
        if (!jQuery.support.style && notxml && name === "style") {
          if (set) {
            elem.style.cssText = String(value);
          }
      ...
      while ((type = types[i++]) !== null) {
        ...
        if (name === "live") {
          ...
          for (var j = 0, l = context.length; j < l; j++) {
            jQuery.event.add(
              context[j],
              "live." + liveConvert(type, selector),
              {
                data: data,
                selector: selector,
                handler: fn,
  ...
  (function () {
    ...
    var Expr = (Sizzle.selectors = {
      ...
      filters: {
        ...
        parent: function (elem) {
          return Boolean(elem.firstChild);
        },
        ...
        has: function (elem, i, match) {
          return Boolean(Sizzle(match[3], elem).length);
        },
        ...
        button: function (elem) {
          return (
            elem.type === "button" || elem.nodeName.toLowerCase() === "button"
          );
        },
    ...
    if (document.documentElement.contains) {
      ...
      Sizzle.contains = function (a, b) {
        return Boolean(a.compareDocumentPosition(b) & 16);
      };
    } else {
  ...
  jQuery.fn.extend({
    ...
    is: function (selector) {
      return Boolean(selector) && jQuery.filter(selector, this).length > 0;
    },
  ...
  function winnow(elements, qualifier, keep) {
    if (jQuery.isFunction(qualifier)) {
      return jQuery.grep(elements, function (elem, i) {
        var retVal = Boolean(qualifier.call(elem, i, elem));
        return retVal === keep;
      });
    ...
    jQuery.cssHooks.opacity = {
      get: function (elem, computed) {
        ...
        return ropacity.test(
          ...
          ? String(parseFloat(RegExp.$1) / 100)
          : computed
          ? "1"
          : "";
      },
      ...
      var // Create the final options object
        ...
        jqXHR = {
          ...
          setRequestHeader: function (name, value) {
            if (!state) {
              requestHeaders[
                name.toLowerCase().replace(rucHeaders, rucHeadersFunc)
              ] = value;
            }
            return this;
          },
  ...
  jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
    ...
    if (
      ...
      (s.jsonp !== false &&
        (jsre.test(s.url) || (dataIsString && jsre.test(s.data))))
    ) {
  ...
  jQuery.support.ajax = Boolean(testXHR);
  ...
  jQuery.offset = {
    ...
    setOffset: function (elem, options, i) {
      ...
      curTop = calculatePosition
        ? curPosition.top
        : parseInt(curCSSTop, 10) || 0;
