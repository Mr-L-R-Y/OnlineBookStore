...
Q6MenuBar.prototype.toString = function () {
  ...
  var str =
    ...
    ';" class = "menuBar" name="menuBar" onClick="' +
    this.obj +
    '.showMenu(event, this)">\n';
  // menuBar的标题<div>
  str +=
...
Q6MenuBar.prototype.menu2Str = function (menuName) {
  ...
  str +=
    ...
    icon +
    '"/></span><span class="menuTitleText">' +
    menuName +
    "</span></div>\n";
  // 菜单内容对象的<div>，所有菜单荐都存放在这个<div>中。
  str +=
    '<div style="color:' +
    this.colors[this.colorStyle].menuContentColor +
...
Q6MenuBar.prototype.item2Str = function (menuItem) {
  return (
    ...
    ";background-color:" +
    this.colors[this.colorStyle].itemBgColor +
    "; color:" +
    this.colors[this.colorStyle].itemColor +
    ';" class="menuItem" onMouseMove="' +
    this.obj +
    '.itemMouseMove(this)" onMouseOut="' +
    this.obj +
    '.itemMouseOut(this)" onClick="skip(\'' +
    menuItem.url +
    "', '" +
    menuItem.frameName +
    "')\">" +
...
Q6MenuBar.prototype.itemMouseMove = function (e) {
  e.style.border =
    "1px solid " + this.colors[this.colorStyle].itemBorderMoveColor;
